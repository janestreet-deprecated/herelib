(* OASIS_START *)
(* DO NOT EDIT (digest: 4bf303500d27f842230e58cc66fc68ac) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            ["(C) 2013 Jane Street Group LLC <opensource@janestreet.com>"];
          maintainers =
            ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          authors = ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          homepage = Some "https://github.com/janestreet/herelib";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Herelib_dummy"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "herelib";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "herelib";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "[?3\165K\170\017\211\147E\230\158\184,\144\t";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
